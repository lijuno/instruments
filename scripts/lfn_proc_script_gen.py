...
if __name__ == '__main__':
    ...
    f.write('% Save data in txt files\n')
    f.write("data1 = [Idc_list(IX)', alpha_list(IX)'];\n")
    f.write("data2 = [Idc_list(IX)', SI0_list(IX)'];\n")
    f.write("save -ascii 'Idc_alpha.txt' 'data1'\n")
    f.write("save -ascii 'Idc_SI0.txt' 'data2'\n")
    f.close()
